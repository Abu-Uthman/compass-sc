    ...
    <section className="bg-primary py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-lg bg-[#D4A017] px-8 py-4 text-base font-bold text-white hover:bg-[#b88a14] transition-all shadow-lg hover:shadow-xl"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-lg border-2 border-[#fafbfc] bg-transparent px-8 py-4 text-base font-bold text-[#fafbfc] hover:bg-[#fafbfc]/10 transition-all"
          >
            {SITE_CONFIG.phone}
          </a>
        </div>
